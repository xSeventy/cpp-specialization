...
public:
    AirportCounter()
        ...
        AirportCounter(TIterator first, TIterator last)
            : AirportCounter() {
    ...
    void EraseOne(TAirport airport) {
        size_t& count = airports[static_cast<size_t>(airport)].second;
...
private:
    //unordered_map<TAirport, int> airports;
    //vector<pair<TAirport, size_t>> airports;
